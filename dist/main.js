...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _listScore_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./listScore.js */ \"./modules/listScore.js\");\n\n\nconst sub = (user, score) => {\n  if (user || score !== '') {\n    const sentToApi = async () => {\n      const request = await fetch(\n        'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/c44aacc0-0eae-11ed-964a-81cbf21bdb35/scores/',\n        {\n          method: 'POST',\n          body: JSON.stringify({\n            user: `${user}`,\n            score,\n          }),\n          headers: {\n            'Content-type': 'application/json; charset=UTF-8',\n          },\n        },\n      );\n      return request.status;\n    };\n    sentToApi()\n      .then((res) => res)\n      .then(() => {\n        (0,_listScore_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n      });\n  }\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (sub);\n\n//# sourceURL=webpack://webpack-tutorial/./modules/submit.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_listScore_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/listScore.js */ \"./modules/listScore.js\");\n/* harmony import */ var _modules_submit_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/submit.js */ \"./modules/submit.js\");\n\n\n\n\n(0,_modules_listScore_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n\nconst refresh = document.querySelector('refresh');\nrefresh.addEventListener('click', () => {\n  (0,_modules_listScore_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n});\n\nconst scoretable = document.getElementById('submitbtn');\nscoretable.addEventListener('click', () => {\n  const user = document.querySelector('#user').value;\n  const score = document.querySelector('#score').value;\n  (0,_modules_submit_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(user, score);\n});\n\n//# sourceURL=webpack://webpack-tutorial/./src/index.js?");
